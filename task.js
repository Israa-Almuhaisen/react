...
// *Arrow Function:__________________________
...
// ____الطريقه التانيه_____

// let nums = [2, 4, 5];
// const sumOfSquaredArray = nums.map(num => num * num).reduce((acc, cur) => acc + cur);
// const average = sumOfSquaredArray / nums.length;
// _________الطربقه التالته______________________
